      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-24">
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-slate-800/90 via-gray-800/90 to-slate-900/90 backdrop-blur-2xl rounded-[4rem] p-12 md:p-20 border border-gray-700/50 shadow-2xl overflow-hidden hover:border-orange-500/50 transition-all duration-500">
              {/* Static Crown */}
              ...
              <div className="relative z-10">
                ...
                <div className="grid lg:grid-cols-2 gap-8 mb-12">
                  <div className="bg-gradient-to-br from-orange-900/30 to-red-900/30 rounded-3xl p-8 border border-orange-500/30 backdrop-blur-sm hover:scale-105 hover:rotate-1 transition-all duration-300">
                  ...
                  <div className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 rounded-3xl p-8 border border-blue-500/30 backdrop-blur-sm hover:scale-105 hover:-rotate-1 transition-all duration-300">
                    <div className="flex items-center mb-6">
                ...
                {/* Feature Highlight */}
                <div className="text-center bg-gradient-to-r from-yellow-900/40 via-orange-900/40 to-red-900/40 rounded-3xl p-10 border border-yellow-500/30 relative overflow-hidden hover:scale-105 transition-all duration-300">
                  <div className="absolute inset-0 bg-gradient-to-r from-yellow-500/5 to-red-500/5"></div>
                  <div className="relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-6 mt-12">
                  <div className="bg-gradient-to-br from-emerald-900/30 to-teal-900/30 rounded-2xl p-6 border border-emerald-500/30 hover:scale-105 transition-all duration-300">
                  ...
                  <div className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 rounded-2xl p-6 border border-purple-500/30 hover:scale-105 transition-all duration-300">
        ...
        <div className="mb-24">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div
                key={index}
                className="group hover:-translate-y-5 hover:scale-105 hover:rotate-2 transition-all duration-300"
              >
                <div className={`relative bg-gradient-to-br from-slate-800/90 to-gray-900/90 backdrop-blur-xl rounded-2xl p-8 border border-gray-700/50 shadow-2xl ${value.shadow} hover:shadow-3xl ${value.glow} transition-all duration-500 overflow-hidden`}>
                  ...
                  <div className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${value.gradient} opacity-0 group-hover:opacity-20 transition-opacity duration-500 blur-xl`}></div>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="relative mb-8">
                      <div className={`bg-gradient-to-r ${value.gradient} p-4 rounded-xl shadow-2xl ${value.shadow} relative overflow-hidden group-hover:scale-110 group-hover:-rotate-12 transition-all duration-300`}>
                      ...
                      {/* Static Particles */}
                      <div className="absolute -top-2 -right-2 w-3 h-3 bg-orange-400 rounded-full opacity-75"></div>
                      <div className="absolute -bottom-2 -left-2 w-2 h-2 bg-pink-400 rounded-full opacity-75"></div>
                    </div>

                    <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-orange-400 group-hover:to-pink-400 group-hover:bg-clip-text transition-all duration-300">
                      {value.title}
                    </h3>
                    ...
                    {/* Progress Bar Effect */}
                    <div className={`h-1 bg-gradient-to-r ${value.gradient} rounded-full transform origin-left`}></div>
                  </div>
        ...
        <div className="mb-24">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            {owners.map((owner, index) => (
              <div
                key={index}
                className="group hover:-translate-y-5 hover:scale-105 hover:rotate-1 transition-all duration-400"
              >
                <div className="relative bg-gradient-to-br from-slate-800/95 via-gray-800/95 to-slate-900/95 backdrop-blur-2xl rounded-[3rem] p-12 border border-gray-600/50 shadow-2xl hover:shadow-yellow-500/20 transition-all duration-500 overflow-hidden">
                  ...
                  <div className="absolute inset-0 rounded-[3rem] border-2 border-transparent bg-gradient-to-r from-yellow-500/50 via-orange-500/50 to-red-500/50 opacity-0 group-hover:opacity-100 transition-opacity duration-1000" style={{ padding: '2px' }}>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="relative mb-10">
                      <div className="relative group-hover:scale-110 group-hover:-rotate-3 transition-all duration-500">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-r from-yellow-400/30 to-orange-500/30 rounded-full blur-2xl scale-105 group-hover:scale-120 transition-transform duration-500"></div>
                        ...
                        <div className="relative">
                          ...
                          {/* Premium Badge */}
                          <div className="absolute -top-4 -right-4 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full p-4 shadow-2xl border-4 border-white">
                    ...
                    <div className="text-center space-y-6">
                      <h3 className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 hover:scale-105 transition-all duration-300">
                        {owner.name}
                      </h3>

                      <div className="bg-gradient-to-r from-yellow-500 to-orange-600 text-white px-8 py-4 rounded-full inline-block font-bold text-xl shadow-2xl border-2 border-yellow-400/50 hover:scale-105 hover:-translate-y-1 transition-all duration-300">
                        {owner.role}
                      </div>

                      <div className="space-y-4">
                        <div className="bg-gradient-to-r from-purple-600/80 to-pink-600/80 backdrop-blur-sm rounded-2xl p-6 border border-purple-400/30 shadow-xl hover:scale-105 hover:-translate-y-1 transition-all duration-300">
